...
/**
 * Sunset.vue - サンセットマップページコンポーネント
 *
 * サンセットマップを表示し、マップ上の重要ポイントとそれに紐づくサブポイントを
 ...
 */
const redPoints = ref([
  { id: 1, x: 35, y: 25, name: 'サイトA' },
  { id: 2, x: 65, y: 75, name: 'サイトB' },
...
const bluePoints = ref([
  { id: 1, redPointId: 1, x: 30, y: 20, name: 'Aロビー' },
  { id: 2, redPointId: 1, x: 40, y: 30, name: 'Aガーデン' },
  { id: 3, redPointId: 2, x: 60, y: 70, name: 'Bロビー' },
  { id: 4, redPointId: 2, x: 70, y: 80, name: 'Bショップ' },
  { id: 5, redPointId: 3, x: 45, y: 45, name: 'ミッドマーケット' },
  { id: 6, redPointId: 3, x: 55, y: 55, name: 'ミッドコート' },
]);
...
<template>
  <div class="page">
    ...
    <div class="page__left">
      <MapLeftMenu map-name="Sunset - サンセット" />
    </div>
    <!-- メインコンテンツエリア（マップ表示） -->
