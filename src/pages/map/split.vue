...
/**
 * Split.vue - スプリットマップページコンポーネント
 *
 * スプリットマップを表示し、マップ上の重要ポイントとそれに紐づくサブポイントを
 ...
 */
const redPoints = ref([
  { id: 1, x: 25, y: 30, name: 'サイトA' },
  { id: 2, x: 75, y: 70, name: 'サイトB' },
...
const bluePoints = ref([
  ...
  { id: 2, redPointId: 1, x: 30, y: 35, name: 'Aランプ' },
  { id: 3, redPointId: 2, x: 70, y: 65, name: 'Bメイン' },
  { id: 4, redPointId: 2, x: 80, y: 75, name: 'Bアレイ' },
  { id: 5, redPointId: 3, x: 45, y: 45, name: 'ベント' },
  { id: 6, redPointId: 3, x: 55, y: 55, name: 'シャワー' },
]);
...
<template>
  <div class="page">
    ...
    <div class="page__left">
      <MapLeftMenu map-name="Split - スプリット" />
    </div>
    <!-- メインコンテンツエリア（マップ表示） -->
