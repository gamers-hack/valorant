...
/**
 * Ascent.vue - アセントマップページコンポーネント
 *
 * アセントマップを表示し、マップ上の重要ポイントとそれに紐づくサブポイントを
 ...
 */
const redPoints = ref([
  { id: 1, x: 25, y: 15, name: 'サイトA' },
  { id: 2, x: 75, y: 85, name: 'サイトB' },
...
const bluePoints = ref([
  { id: 1, redPointId: 1, x: 20, y: 25, name: 'Aメイン' },
  { id: 2, redPointId: 1, x: 30, y: 10, name: 'Aロビー' },
  { id: 3, redPointId: 2, x: 80, y: 80, name: 'Bメイン' },
  { id: 4, redPointId: 2, x: 70, y: 90, name: 'Bロビー' },
  { id: 5, redPointId: 3, x: 45, y: 55, name: 'ミッドトップ' },
  { id: 6, redPointId: 3, x: 55, y: 45, name: 'ミッドボトム' },
]);
...
<template>
  <div class="page">
    ...
    <div class="page__left">
      <MapLeftMenu map-name="Ascent - アセント" />
    </div>
    <!-- メインコンテンツエリア（マップ表示） -->
